...
def draw_landmarks(im, landmarks, colors=None, alpha=0.75,
    ...
    facial_landmarks = matrix2dict(landmarks)
...
#print((landmarks == dict2matrix(matrix2dict(landmarks))).all())
#print(np.array_equal(landmarks, dict2matrix(matrix2dict(landmarks))))
#print(np.array_equiv(landmarks, dict2matrix(matrix2dict(landmarks))))
#print(landmarks - dict2matrix(matrix2dict(landmarks)))